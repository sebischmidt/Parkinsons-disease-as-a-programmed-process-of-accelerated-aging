---
title: "Processing methylation data - GSE111629"
...
pheno$Raw_Name <- sub("^X", "", pheno$source_name_ch1)
# Update raw name for GSM3035585_3999984061_R03C01
pheno$Raw_Name[pheno$Raw_Name == "3999984061_R03C02"] <- "3999984061_R03C01"
pheno$Raw_Name[pheno$Raw_Name == "3999984061_R04C02"] <- "3999984061_R04C01"
pheno$Raw_Name[pheno$Raw_Name == "3999984061_R05C02"] <- "3999984061_R05C01"
pheno$Raw_Name[pheno$Raw_Name == "3999984061_R06C02"] <- "3999984061_R06C01"
...
pheno <- pheno %>%
  mutate(Condition = recode(Condition,
    ...
    "PD-free control" = "Control"
  ))

# Remove samples without raw data
pheno <- pheno %>%
  filter(description != "raw data unavailable for this sample")



# Select only the desired columns
pheno <- pheno[, c("Sample_Name", "Raw_Name", "Condition", "Gender", "Tissue", "age", "ID")]
